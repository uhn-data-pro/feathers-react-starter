	...
	handleRegisterUser = (event) => {
		...
		app
			...
			.catch(() =>
				this.setState({
					snackBarOpen: true,
					snackBarMessage: 'Sorry, this email has already been used',
				})
			);
	};
		...
		return (
			<div style={{ padding: '0 20px' }}>
				...
				<TextField
					...
					margin='normal'
					onChange={(event) =>
						this.handleRegistrationChange('email', event.target.value)
					}
					type='email'
					variant='outlined'
					value={email}
				...
				<TextField
					...
					margin='normal'
					onChange={(event) =>
						this.handleRegistrationChange('password', event.target.value)
					}
					type='password'
					variant='outlined'
					value={password}
